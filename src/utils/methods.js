...
const { productsJsonTemplate } = require("@utils/types");
...
const NFT_STORAGE_KEY =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweGQyOWE0MTkyZjUzOTk3MTQ3ODBlNkQxNmVjMzRlOUJDOTNERDU5RjUiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTY3Nzk0NzkzMDMxOSwibmFtZSI6Im5mdC1tYXJrZXRwbGFjZSJ9.wVGQJhgjdwdJCZXvCbnyR8eSSR3JkOyE0q2mu7rZyfM";
 ...
 * @param {number} price a text description for the NFT
 */
...
async function genFakeData() {
    const accessToken = "vi3fws34971ob16bsbcrpkg9t1t78mmvd9cqx5m7";
    // axios.get(/)
}
